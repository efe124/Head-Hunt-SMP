        ...
        for (String shapeString:shapeStrings){
            ...
            for(char character:shapeString.toCharArray()){
                ...
                if(!addedMaterials.contains(character)){
                    ...
                    if(material==null) throw new InvalidRecipeException("extra-head.materials."+character +" is not a valid material. Please see https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/Material.html for valid materials.");
